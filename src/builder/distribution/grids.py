...
from pyray import Transform, Vector3, vector3_add, vector3_scale, vector3_subtract
...
def radial_grid_transforms(
    ...
    while angle_deg < 360.0:
        ...
        offset: Vector3 = vector3_scale(
            Vector3(cos(angle_rad), 0.0, sin(angle_rad)),
            radius,
        )
        transforms.append(transform_at(vector3_add(origin, offset)))
        angle_deg += spacing
    return transforms
